...
<div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <div class="card">
    <div class="center">
      <img src="img/Basic.png" alt="Sudip" style="width:100%">
      <img src="img/Sparkslogo.png" alt="Sudip" style="width:25%">
      <div class="container">
      <style>
      h2 {font-family:'Comic Sans MS', 'Chalkboard SE', 'Comic Neue', sans-serif; }
        ...
        <p><i class="fas fa-envelope-square"> sudip.banik@stu.adamasuniversity.ac.in</i></p>
        </div>
      </div>
  </div>
 </body>
